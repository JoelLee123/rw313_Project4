...
public class ClientHandler implements Runnable {
    ...
    public ClientHandler(Socket socket) {
        try {
            ...
            this.clientUsername = usernameMessage.getTextContent();
            System.out.println("Message: " + clientUsername);
        ...
        while (socket.isConnected()) {
            try {
                ...
                if (!messageFromClient.getIsAudio()) {
                    ...
                    if (messageFromClient.getTextContent().equals("/leave") || messageFromClient == null) {
